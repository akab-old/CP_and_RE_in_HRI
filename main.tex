...
On other hand, we must deal with some contraindications. Some of these are:
\begin{itemize}
...
Instead, I will show how to deal with uncertainty in the representation
...
\newline
\noindent As we have seen in section \ref{sec:formalism}, different planning formalisms try to capture different aspects of real-world problems. By the way they model and abstract the world, they also produce different solution concepts.\\
...
In this section I will characterize some example, from the problem definition to the plan generation.
