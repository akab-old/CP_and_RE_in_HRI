...
Epistemic logic could helps us to represent the uncertainties the real world introduce in the domain.\\
In this case the states are called belief states, since they represent the uncertainty of the agent about the world.
The problem is that the belief space is computationally exponentially bigger than state space. A good representation is thus needed.  \\
A solution is to consider only a small group of states that represents the epistemic knowledge of the robot.\\
