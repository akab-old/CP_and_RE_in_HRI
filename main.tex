...
\begin{figure}[H]
	...
	\caption{a simple interface to generate PNPs from (K)PDDL.}
\end{figure}
...
Such complex PNPs are very time consuming to be manually constructed and error prone. However, we can notice that doubling the number of epistemic variables, the time for the planner to run exponentially increase from 0.569s to 23,8252s! The run time of our system however remain almost the same (from 0,008s to 0,009).
