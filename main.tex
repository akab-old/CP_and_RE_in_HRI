...
\noindent The image indicates that there is a person in front of shop 2, another wandering nearby shop 6 and a third person in front of him. \\
...
\noindent where $X$ represents the complete state variables, $Y$ are the environmental state variables while $Z$ are the epistemic state variables (i.e. the state the characterise the robot knowledge). \\
